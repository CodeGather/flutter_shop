 ...
 * @LastEditTime: 2019-04-13 16:11:28
 */
...
class _LoginPassPageState extends State<LoginPassPage>with SingleTickerProviderStateMixin {
  final _formKey = GlobalKey<FormState>();
  // 定义参数
  String _mobile, _password, _countryCode;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          AppLocalizations.$t('login.tab.tab_account')
        ),
      ),
      ...
      decoration: InputDecoration(
        ...
        prefixIcon: Container(
          ...
          child: Align(
            ...
            child: Text(
              AppLocalizations.$t('login.pass_tip')
            ),
          ),
        ),
        ...
        child: FlatButton(
          ...
          onPressed: () {
            ...
            if (_formKey.currentState.validate()) {
              ...
              //TODO 执行登录方法
              print('email:$_mobile , code:$_password , 国家代码:$_countryCode , 是否勾选：$isChecked');
            }
          },
          shape: StadiumBorder(
            side: BorderSide(
