...
import 'package:flutter_shop/model/search_history.dart';
        ...
        builder: (FormFieldState<T> field) {
          return new InputDecorator(
            ...
            child: _isEmpty(field) ? null : new Text(
              widget.formatter != null ? widget.formatter(field.value) : field.value.toString(),
              style: valueStyle
            ),
          );
        },
              ...
              children: <Widget>[
                ...
                new Expanded(
                  child: new MaterialSearchInput(
                    placeholder: AppLocalizations.$t('topics.search'),
...
class _History extends State<History> {
  SearchHistoryList searchHistory = new SearchHistoryList();
  ...
  buildChips(BuildContext context) {
    List<Widget> list = [];
    List<SearchHistory> historyList = searchHistory.getList();
